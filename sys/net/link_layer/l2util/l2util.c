                           ...
                           eui64_t *eui64)
{
    ...
    defined(MODULE_NIMBLE_NETIF) || defined(MODULE_NIMBLE_JELLING)
...
#endif  /* defined(MODULE_CC110X) || defined(MODULE_NRFMIN) */
#if defined(MODULE_NIMBLE_NETIF) || defined(MODULE_NIMBLE_JELLING)
        case NETDEV_TYPE_BLE:
            /* for BLE we don't flip the universal/local flag... */
            return l2util_eui64_from_addr(dev_type, addr, addr_len, iid);
#endif  /* defined(MODULE_NIMBLE_NETIF) || defined(MODULE_NIMBLE_JELLING) */
        default: {
